...
class MeetingsPolicy
{
    ...
    {
        return $user->can('view_any_meetings');
    }
    ...
    {
        return $user->can('update_meetings');
    }
    ...
    {
        return $user->can('delete_any_meetings');
    }
    ...
    {
        return $user->can('force_delete_meetings');
    }
    ...
    {
        return $user->can('force_delete_any_meetings');
    }
    ...
    {
        return $user->can('restore_meetings');
    }
    ...
    {
        return $user->can('restore_any_meetings');
    }

    /**
     * Determine whether the user can replicate.
     */
    public function replicate(User $user, Meetings $meetings): bool
    {
        return $user->can('replicate_meetings');
    }
    ...
    {
        return $user->can('reorder_meetings');
    }
}
