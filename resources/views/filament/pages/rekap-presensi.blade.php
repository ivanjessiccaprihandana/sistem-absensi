<x-filament::page>
    ...
    <div class="mb-4 w-1/3">
        ...
        <select wire:model="filterJurusan" wire:change="$refresh" id="filterJurusan"
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white border rounded shadow">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="9" class="text-center text-gray-500">Data tidak ditemukan untuk jurusan ini.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
